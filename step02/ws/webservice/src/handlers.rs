...
use crate::{modelds::Course, state::AppState};
...
pub fn new_course(new_course: web::Json<Course>, app_state: web::Data<AppState>) -> HttpResponse {
...
mod tests {
    ...
    use crate::{
        handlers::{get_course_detail, get_courses_for_teacher},
        modelds::Course,
        state::AppState,
    };
